...
/**
 * The customer delete processor implementation.
 *
 * @author     Tim Wagner <t.wagner@techdivision.com>
 ...
 */
class CustomerDeleteProcessor extends AbstractDeleteProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            SqlStatementKeys::DELETE_CUSTOMER => $this->loadStatement(SqlStatementKeys::DELETE_CUSTOMER)
        );
    }
}
