...
/**
 * TechDivision\Import\Customer\Actions\Processors\CustomerCreateProcessor
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The customer create processor implementation.
 *
 * @author    Tim Wagner <t.wagner@techdivision.com>
 * @copyright 2018 TechDivision GmbH <info@techdivision.com>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.techdivision.com
 */
class CustomerCreateProcessor extends AbstractCreateProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            SqlStatementKeys::CREATE_CUSTOMER => $this->loadStatement(SqlStatementKeys::CREATE_CUSTOMER)
        );
    }
